...
# plot(DLHRWAGE ~ log(HRWAGEL), data = twins2, xlim = c(0,5))
```
...
For example,
```{r}
new_x <- data.frame(log(HRWAGEL) = c(10, 20, 30)
predict(twins_lm_fit, new_x, interval = "confidence")
predict(twins_lm_fit, new_x, interval = "prediction")
