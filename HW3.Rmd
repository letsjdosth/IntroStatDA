...
'rm' and 'lstat', 'rm' and 'medv', 'lstat' and 'medv' have some increasing/decreasing relationship.
...
Although none of the predictors are very satisfactory to be associate with per capita crime rate,
...
'lstat' and  'medv' seems to have weak quadratic or exponential-like relationships. But I think they are too weak.
...
In the case of crime rates, there a lots of suburbs that have extremely high crime rate comparing to the other towns.
However, although the range of tax rates are large, they don't seem to particularly high, according to the boxplot.
Likewise, the difference between maximum and minimum pupil-teacher rates is quite big (Yes, they are 'ratios'!),
...
The suburb of the 399th row has lowest median value of owner occupied homes.
...
From boxplot, we can find that the 399th suburbs also has extreme values 
for 'zn', 'age', 'dis', 'rad', 'black' and quite high value of 'crim', 'nox', 'tax'
comparing to the overall range of each predictor.
...
Their per capia crime rates are low, and proportions of blacks are high.
