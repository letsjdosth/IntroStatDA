...
A better model evaluation would have been possible if I devided the training and testing data from the beginning, 
...
Even under the best threshold, and even if this is not a 'testing error' but 'training error',
...
it is also a good idea to split the training and testing data.
...
Let's fit this new model after splitting the dataset to training data and testing data.
Now, the number of observations are 985 in the training dataset,
and 104 in the testing dataset.
...
Let's make the confusion table using the testing dataset.
...
Among 104 points of the testing dataset, $7 + 58 = 65$ cases (62.5%) are correctly predicted.
